...
public class UnlockStmt implements IStmt {
    ...
    public PrgState execute(PrgState state) throws MyException {
        ...
        try {
            ...
            if((val == null) || !val.getType().equals(new IntType())) {
                throw new MyException("Unlock: variable is not of type int");
            }

            int foundIndex = ((IntValue) val).getVal();

            if(!state.getLockTable().containsKey(foundIndex)) {
                throw new MyException("Unlock: index not found in LockTable");
            }
    ...
    public MyIDictionary<String, IType> typeCheck(MyIDictionary<String, IType> typeEnv) throws MyException {
        ...
        else throw new MyException("Unlock: variable must be of type int.");
    }
